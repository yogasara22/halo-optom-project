...
export default function OptometristProfileScreen() {
    ...
    const accountItems = [
        ...
        { icon: 'wallet', label: 'Riwayat Pendapatan', action: () => Alert.alert('Info', 'Fitur riwayat pendapatan akan segera hadir'), color: '#f0fdf4', iconColor: '#16a34a' },
    ];
    ...
    return (
        <View style={styles.root}>
            ...
            <View style={styles.headerBackground}>
                <LinearGradient
                    colors={['#16a34a', '#22c55e']} // Green gradient for optometrist
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
                ...
                <View style={styles.profileCard}>
                    <View style={styles.profileRow}>
                        ...
                        <View style={styles.profileInfo}>
                            <Text style={styles.userName} numberOfLines={1}>{user?.name || 'Optometris'}</Text>
                            <Text style={styles.userEmail} numberOfLines={1}>{user?.email || 'email@example.com'}</Text>
                            <View style={styles.roleTag}>
                                <Text style={styles.roleText}>Optometris</Text>
                            </View>
                        </View>
                    </View>
                </View>
