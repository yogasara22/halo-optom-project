...
import { View, Text, TouchableOpacity, ScrollView, TextInput, Image, StyleSheet, Platform, ActivityIndicator } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f8fafc' }}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.push('/patient')} style={styles.backBtn}>
          <Ionicons name="arrow-back" size={20} color="#0f172a" />
        </TouchableOpacity>
        <Text style={styles.headerTitle}>Buat Janji Pemeriksaan</Text>
        <View style={{ width: 36 }} />
      </View>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 120 }}>
        ...
        {/* Jika belum ada user terpilih via params, tampilkan list. Jika sudah ada, tampilkan info singkat user terpilih */}
        {!optometristId ? (
          <>
