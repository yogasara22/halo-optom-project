    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-green-50">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2 group">
              <div className="relative">
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-[#2563EB] to-[#3DBD61] rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300 blur"></div>
              </div>
              <span className="text-2xl font-bold bg-gradient-to-r from-[#2563EB] to-[#3DBD61] bg-clip-text text-transparent">
                Halo Optom
              </span>
            </div>
            <nav className="hidden md:flex space-x-8">
              {['Fitur', 'Layanan', 'Tentang', 'Kontak'].map((item, index) => (
                ...
                >
                  {item}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#2563EB] to-[#3DBD61] group-hover:w-full transition-all duration-300"></span>
                </a>
              ))}
            </nav>
            <Link 
              href="/login" 
              className="relative bg-gradient-to-r from-[#2563EB] to-[#3DBD61] text-white px-6 py-2 rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-0.5 group overflow-hidden"
            >
              <span className="relative z-10">Admin Login</span>
              <div className="absolute inset-0 bg-gradient-to-r from-[#3DBD61] to-[#2563EB] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </Link>
          </div>
        </div>
      </header>
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-[#2563EB]/10 to-[#3DBD61]/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-[#3DBD61]/10 to-[#2563EB]/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-blue-100/20 to-green-100/20 rounded-full blur-3xl animate-spin" style={{animationDuration: '20s'}}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up delay-200">
              <span className="bg-gradient-to-r from-gray-900 via-[#2563EB] to-gray-900 bg-clip-text text-transparent">
                Solusi Kesehatan Mata
              </span>
              <span className="block bg-gradient-to-r from-[#2563EB] to-[#3DBD61] bg-clip-text text-transparent mt-2">
                Terdepan
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up delay-600">
              <button className="group relative bg-gradient-to-r from-[#2563EB] to-[#3DBD61] text-white px-10 py-4 rounded-2xl text-lg font-semibold hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
              ...
              <button className="group relative border-2 border-[#3DBD61] text-[#3DBD61] px-10 py-4 rounded-2xl text-lg font-semibold hover:bg-[#3DBD61] hover:text-white transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#3DBD61] to-[#2563EB] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
              </button>
            </div>
              ...
              {[
                ...
                return (
                  <div key={index} className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-white/20">
                    ...
                    <div className="text-3xl font-bold bg-gradient-to-r from-[#2563EB] to-[#3DBD61] bg-clip-text text-transparent mb-2">
                      {stat.number}
                    </div>
      ...
      {/* Features Section */}
      <section id="fitur" className="py-24 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#2563EB]/10 to-[#3DBD61]/10 rounded-full border border-[#2563EB]/20 mb-6">
              <Sparkles className="h-4 w-4 text-[#2563EB] mr-2" />
              <span className="text-sm font-medium text-[#2563EB]">Teknologi Terdepan</span>
            </div>
            <h2 className="text-5xl font-bold bg-gradient-to-r from-gray-900 to-[#2563EB] bg-clip-text text-transparent mb-6">
              Fitur Unggulan
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              return (
                <div 
                  key={index} 
                  className={`group relative text-center p-8 rounded-3xl border transition-all duration-500 transform hover:-translate-y-3 cursor-pointer ${
                    isActive 
                      ? 'bg-gradient-to-br from-white to-blue-50 border-[#2563EB]/30 shadow-2xl shadow-blue-500/20 scale-105' 
                ...
                >
                  ...
                  {/* Floating Icon */}
                  <div className={`relative z-10 bg-gradient-to-r ${feature.color} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg`}>
                    <IconComponent className="h-10 w-10 text-white" />
                    <div className={`absolute inset-0 bg-gradient-to-r ${feature.color} rounded-2xl blur opacity-50 group-hover:opacity-75 transition-opacity duration-300`}></div>
                  </div>
                  ...
                  {/* Hover Effect Border */}
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-[#2563EB] to-[#3DBD61] opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-xl"></div>
                </div>
              );
            })}
          </div>
      ...
      {/* Services Section */}
      <section id="layanan" className="py-24 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-20 -left-20 w-80 h-80 bg-gradient-to-r from-[#2563EB]/5 to-[#3DBD61]/5 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-20 -right-20 w-96 h-96 bg-gradient-to-r from-[#3DBD61]/5 to-[#2563EB]/5 rounded-full blur-3xl animate-float-delayed"></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border border-white/20 overflow-hidden">
                ...
                <ul className="relative z-10 space-y-4 mb-8">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center group/item">
                      <div className="bg-gradient-to-r from-[#3DBD61] to-[#2563EB] rounded-full p-1 mr-3 group-hover:scale-110 transition-transform duration-300">
                ...
                <button className={`relative z-10 w-full bg-gradient-to-r ${service.gradient} text-white py-4 rounded-2xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group-hover:scale-105 overflow-hidden`}>
                  <span className="relative z-10">Pilih Layanan</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-[#3DBD61] to-[#2563EB] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
                
                {/* Decorative Elements */}
                <div className="absolute top-4 right-4 w-20 h-20 bg-gradient-to-r from-[#2563EB]/10 to-[#3DBD61]/10 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Stats Section */}
      <section className="py-24 bg-gradient-to-r from-[#2563EB] via-blue-600 to-[#3DBD61] relative overflow-hidden">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-[#3DBD61] via-green-500 to-[#2563EB] relative overflow-hidden">
        {/* Animated Background Elements */}
        <div className="absolute inset-0">
        ...
        <div className="relative z-10 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              <div className="md:col-span-1">
                <div className="flex items-center space-x-3 mb-6 group">
                  <div className="relative">
                    ...
                    <div className="absolute -inset-2 bg-gradient-to-r from-[#2563EB] to-[#3DBD61] rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300 blur"></div>
                  </div>
                  <span className="text-3xl font-bold bg-gradient-to-r from-[#2563EB] to-[#3DBD61] bg-clip-text text-transparent">
                    Halo Optom
                  </span>
                </div>
                <p className="text-gray-300 mb-6 leading-relaxed">
                  Platform kesehatan mata terdepan di Indonesia dengan teknologi AI dan layanan profesional terpercaya.
                </p>
                <div className="flex space-x-4">
                  {['f', 't', 'i', 'y'].map((social, index) => (
                    <div key={index} className="group w-12 h-12 bg-gradient-to-r from-[#2563EB] to-[#3DBD61] rounded-xl flex items-center justify-center hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  {['Konsultasi Online', 'Pemeriksaan Homecare', 'Toko Kacamata', 'Rekam Medis'].map((item, index) => (
                    <li key={index}>
                      <a href="#" className="text-gray-300 hover:text-[#3DBD61] transition-all duration-300 flex items-center group">
              ...
              <div>
                <h3 className="text-xl font-bold mb-6 text-white">Perusahaan</h3>
                <ul className="space-y-4">
                  {['Tentang Kami', 'Karir', 'Blog', 'Press'].map((item, index) => (
                    <li key={index}>
                      <a href="#" className="text-gray-300 hover:text-[#3DBD61] transition-all duration-300 flex items-center group">
                        <ArrowRight className="h-4 w-4 mr-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300" />
                        {item}
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { icon: Mail, text: 'info@halooptom.com' },
                    { icon: MapPin, text: 'Jakarta, Indonesia' }
                  ].map((contact, index) => {
                    const IconComponent = contact.icon;
                    return (
                      <div key={index} className="flex items-center group cursor-pointer">
                        <div className="bg-gradient-to-r from-[#2563EB] to-[#3DBD61] p-2 rounded-lg mr-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex">
                    ...
                    />
                    <button className="bg-gradient-to-r from-[#2563EB] to-[#3DBD61] px-6 py-3 rounded-r-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-0.5">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-6 text-gray-400">
                  {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map((item, index) => (
                    <a key={index} href="#" className="hover:text-[#3DBD61] transition-colors duration-300">
                      {item}
                    </a>
                  ))}
                </div>
