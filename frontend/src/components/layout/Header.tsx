...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-xl shadow-lg border-b border-white/20 relative z-50">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-linear-to-r from-[#2563EB]/5 to-[#3DBD61]/5"></div>
        <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-[#2563EB]/10 to-[#3DBD61]/10 rounded-full -translate-y-16 translate-x-16"></div>
      </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3 bg-white/60 backdrop-blur-sm rounded-2xl px-4 py-2 shadow-md hover:shadow-lg transition-all duration-300">
              <div className="relative">
                <div className="w-10 h-10 bg-linear-to-br from-[#2563EB] to-[#3DBD61] rounded-2xl flex items-center justify-center shadow-lg">
